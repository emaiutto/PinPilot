...
namespace MAUI.PinPilot.Fsuipc
{
    public sealed class Profile
    {
        ...
        private const string PROFILE_TESTING = "BONANZA";

        private readonly Offset<string> _AircraftNameOffset = new(DataGroupName: "profile", Address: 0x3D00, ArrayOrStringLength: 128);
