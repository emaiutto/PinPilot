...
public class Offset
{
	...
	internal virtual byte[] DataValue
	{
		get
		{
			return dataValue;
	...
	public void Disconnect() => Disconnect(AfterNextProcess: false);
	...
	public void Disconnect(bool AfterNextProcess)
	{
		...
		{
			FSUIPCConnection.RemoveOffset(this);
		}
	}

	public void Reconnect() => Reconnect(ForNextProcessOnly: false);
...
public class Offset<T> : Offset
{
	...
	{
		fsuipcDataType fsuipcDataType2 = fsuipcDataType.TypeUnknown;
		int num;
