...
namespace MauiSoft.SRP.FsuipcWrapper
{
    ...
    public sealed class OffsetList
    {
        ...
        private void Load()
        {
            ...
            string AircraftPath = Path.Combine(Environment.CurrentDirectory, "profiles", Profile.Profile.Instance.AircraftProfile, "offsets");
        ...
        public dynamic? GetValue(string key)
        {
            ...
            switch (value.DataType)
            {
                ...
                case "Int32":
                    if (value.Offset is Offset<Int32> offsetInt32)
                        return offsetInt32.Value * factor;
                    break;

                case "UInt32":
                    if (value.Offset is Offset<UInt32> offsetUInt32)
